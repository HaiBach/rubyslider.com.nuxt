...
onMounted(() => {
  ...
  setTimeout(() => {
    const $tabsListTemplates = jQuery('#list-templates__tabs')
    if ($tabsListTemplates.length) {
      $tabsListTemplates.rubyslider( tabsOptions )
  ...
  <main>
    <div v-if="$route.params.slug == ''">
      ...
      <div class="list-templates">
        <div id="list-templates__tabs" class="rs01">
          <div
            v-for="(items, tabName) in tabsData"
...
<style scoped>
#list-templates__tabs .rs01pagitem {
...
#list-templates__tabs .rs01pagitem:hover {
  background-color: #e5e5e5;
  color: #000;
}
#list-templates__tabs .rs01pagitem.rs01cur {
